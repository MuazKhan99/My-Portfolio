      ...
      <div className="container">
        <Zoom>
          ...
          <div className="project">
            ...
            <a href="https://github.com/MuazKhan99/Thesis_Neo4j_Implementation">View on GitHub</a>
          </div>
          <div className="project">
            ...
            <a href="https://github.com/MuazKhan99/EventHouse">View on GitHub</a>
          </div>
          <div className="project">
            ...
            <a href="https://revam.tech/">Visit Website</a>
          </div>
          <div className="project">
